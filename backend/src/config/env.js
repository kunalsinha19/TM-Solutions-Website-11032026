...
module.exports = {
  ...
  EMAIL_FROM: process.env.EMAIL_FROM || process.env.SMTP_USER || "support.tmsindia@gmail.com",
  ADMIN_NOTIFICATION_EMAIL: process.env.ADMIN_NOTIFICATION_EMAIL || "support.tmsindia@gmail.com",
