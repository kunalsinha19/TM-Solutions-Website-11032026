...
const icons = {
  ...
  leads:        <Icon d={["M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2", "M9 11a4 4 0 100-8 4 4 0 000 8z", "M23 21v-2a4 4 0 00-3-3.87"]} />,
  taraAnalytics:<Icon d={["M18 20V10", "M12 20V4", "M6 20v-6"]} />,
  blog:         <Icon d={["M12 20h9", "M16.5 3.5a2.121 2.121 0 013 3L7 19l-4 1 1-4L16.5 3.5z"]} />,
...
const NAV = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: "leads",        label: "Tara Leads",     icon: "leads"         },
      { key: "taraAnalytics",label: "Tara Analytics", icon: "taraAnalytics" },
      { key: "blog",         label: "Blog",           icon: "blog"          },
      { key: "stock",        label: "Physical Stock", icon: "stock"         },
