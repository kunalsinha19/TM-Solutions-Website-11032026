      ...
      <form onSubmit={onSubmit} className="grid gap-4 p-4">
        ...
        {status === "error" && (
          <p className="rounded-xl bg-red-50 px-4 py-3 text-center text-xs text-red-600 dark:bg-red-950/30 dark:text-red-400">
            ...
            <a href="mailto:support.tmsindia@gmail.com" className="underline">Email us</a>
          </p>
        )}
    ...
    <form onSubmit={onSubmit} className="grid gap-4 p-4">
      ...
      {status === "error" && (
        <p className="rounded-xl bg-red-50 px-4 py-3 text-center text-xs text-red-600 dark:bg-red-950/30 dark:text-red-400">
          {errorDetail || "Something went wrong."}{" "}
          Please try again or{" "}
          <a href="mailto:support.tmsindia@gmail.com" className="underline">email us directly</a>.
        </p>
      )}
